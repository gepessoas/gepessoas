...
begin
  ...
  cmdAtualizaSolicitacao.Parameters.ParamByName('ID_Cargo').Value       := cbCargo.KeyValue;
...
procedure TfrmAprovacao.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  qryCargos.Close;
end;

procedure TfrmAprovacao.FormShow(Sender: TObject);
begin
  qryCargos.Open;
end;
