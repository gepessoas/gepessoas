...
begin
  ...
  begin
    frmPrincipal.Codigo := qryVeiculo.fields.FieldByName('ID_Cargo').asinteger;
    ...
    frmCadVeiculo.qryVeiculo.Locate('ID_Cargo', frmPrincipal.codigo, [loCaseInsensitive, loPartialKey]);
...
begin
  if (not qryVeiculo.IsEmpty) and (qryVeiculoID_Cargo.value > 0) then
  begin
...
begin
  case cbFiltro.ItemIndex of
    0: ColunaFiltro := 'CD_Cargo';
    1: ColunaFiltro := 'NM_Cargo';
  end;
end;
